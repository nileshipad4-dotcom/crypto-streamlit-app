...
df_g = df_live[
    ["strike_price", "contract_type", "greeks.gamma", "greeks.delta", "greeks.vega"]
]
...
final["Call Gamma △"] = (final["call_gamma_live"] - final["call_gamma_t1"]) * FACTOR / 100
final["Put Gamma △"] = (final["put_gamma_live"] - final["put_gamma_t1"]) * FACTOR / 100
